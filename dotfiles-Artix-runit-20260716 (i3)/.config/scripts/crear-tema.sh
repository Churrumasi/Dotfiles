...
#############################################
wal --cols16 -i "$DEST_DIR/fondo.png" -n
...
modules-right = tray audio battery clock power
...
click-left = ~/.config/scripts/powermenu-alt.sh
